...
# EPIC-22: Animal Management Dashboard

## Overview
**Goal**: Staff CRUD interface for animals: add, edit, status changes, photo management, search/filter.
**Why it matters**: The API exists but there is zero staff UI. Staff cannot manage animals without this dashboard.
