...
| 3 | Password reset tests (0% → 80%) | RAP-405 | EPIC-72 | 5 | READY | RAP-101 ✓ merged PR #62 |
...
| 6 | Structured JSON logging (structlog) | RAP-415 | EPIC-74 | 5 | PR OPEN (#74) | — |
| 7 | Sentry error tracking integration | RAP-416 | EPIC-74 | 3 | PR OPEN (#75) | RAP-415 |
| 8 | Add error.tsx and loading.tsx boundaries | RAP-420 | EPIC-75 | 3 | PR OPEN (#76) | — |
| 9 | Fix /animals page 404 rendering bug | RAP-421 | EPIC-75 | 3 | DONE (PR #77) | — |
| 10 | Integrate Stripe.js Elements into DonationForm | RAP-422 | EPIC-75 | 5 | DONE (PR #78) | — |
