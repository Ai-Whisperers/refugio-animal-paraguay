...
**Active version**: V8 EPIC-41 S3 DONE (PR #328), S5 DONE (PR #330), S4 BLOCKED (PR #329 conflict src/app.py). EPIC-42 S2 DONE (PR #331), S3 DONE (PR #332), S4/S5 planned. V7 EPIC-40 S2 BLOCKED (PR #322 conflict), S3 BLOCKED (PR #323 conflict)
...
| 5 | V8 | Notifications & Communications | 102 | EPIC 41-45 | EPIC-41: S1 DONE (PR #326), S2 DONE (PR #327), S3 DONE (PR #328 — 2026-03-29), S4 BLOCKED (PR #329 — conflict src/app.py), S5 DONE (PR #330 — 2026-03-29). EPIC-42: S1 DONE (RAP-205), S2 DONE (PR #331 — 2026-03-29), S3 DONE (PR #332 — 2026-03-29), S4 planned (RAP-208), S5 planned (RAP-209). |
