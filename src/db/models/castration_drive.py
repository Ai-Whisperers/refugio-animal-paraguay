...
A CastrationDrive is a single-day event where a campaign performs
castrations at a specific location with a defined capacity.
"""
...
class CastrationDrive(Base):
    """A scheduled castration drive event within a campaign."""
    ...
    drive_date: Mapped[date] = mapped_column(sa.Date, nullable=False)
