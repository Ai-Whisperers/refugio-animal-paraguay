...
class Animal(Base):
    ...
    # Back-reference from VetReferral.animal
    vet_referrals: Mapped[list["VetReferral"]] = relationship(  # type: ignore[name-defined]  # noqa: F821
        "VetReferral",
        back_populates="animal",
        lazy="select",
        order_by="VetReferral.created_at.desc()",
    )
