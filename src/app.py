...
from src.api.volunteer_analytics import router as volunteer_analytics_router
...
def create_app() -> FastAPI:
    ...
    application.include_router(volunteer_analytics_router)
    ...
    application.include_router(email_templates_router)  # RAP-216: newsletter template builder
